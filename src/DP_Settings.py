...
class DPS_ServerEntryConfigScreen(ConfigListScreen, Screen):
    ...
    def __init__(self, session, entry):
        ...
        cfglist = [
            ...
            getConfigListEntry(_("Playback Type"), self.current.playbackType),
            getConfigListEntry(_("Transcoding quality"), self.current.quality),
            getConfigListEntry(_("Overwrite within remote path part"), self.current.remotePathPart),
            getConfigListEntry(_("Override with local path part"), self.current.localPathPart),
