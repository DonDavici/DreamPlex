...
# 
#===============================================================================
class DPS_ViewListLong(DP_View):
	'''
	'''
	...
	fastScroll 				= False
	disableBackdrops		= True # we use this to disable backdrop handling in the whole view
	...
	def _refresh(self, selection):
		...
		if selection != None:
			...
			if self.fastScroll == False or self.showMedia == True and self.disableBackdrops == False:
