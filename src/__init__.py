...
def initServerEntryConfig():
	...
	printl("myplexPinProtect: " + str(config.plugins.dreamplex.Entries[i].myplexPinProtect.value), "__init__::initServerEntryConfig", "D", True, 6)
	printl("myplexPin: " + str(config.plugins.dreamplex.Entries[i].myplexPin.value), "__init__::initServerEntryConfig", "D", True, 6)
	...
	printl("myplexHomeUsers: " + str(config.plugins.dreamplex.Entries[i].myplexHomeUsers.value), "__init__::initServerEntryConfig", "D", True, 8)
	printl("myplexCurrentHomeUser: " + str(config.plugins.dreamplex.Entries[i].myplexCurrentHomeUser.value), "__init__::initServerEntryConfig", "D", True, 8)
	printl("myplexCurrentHomeUserPin: " + str(config.plugins.dreamplex.Entries[i].myplexCurrentHomeUserPin.value), "__init__::initServerEntryConfig", "D", True, 8)
